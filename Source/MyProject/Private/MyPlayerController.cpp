...
void AMyPlayerController::BeginPlay()
{
	...
	InputComponent->BindAction("PaintButton", IE_Pressed, this, &AMyPlayerController::PressedToPaint);
	InputComponent->BindAction("PaintButton", IE_Released, this, &AMyPlayerController::ReleasedToPaint);
}
...
void AMyPlayerController::PressedToPaint()
{
	if (CurrentAction != Action::Train)
		CurrentAction = Action::Paint;
}

void AMyPlayerController::ReleasedToPaint()
{
	if (CurrentAction == Action::Paint)
...
void AMyPlayerController::Spell()
{
...
void AMyPlayerController::LoadTemplates()
{
...
void AMyPlayerController::TrainMode(const bool Is)
{
	IsTraining = Is;
...
void AMyPlayerController::AddTemplateToDataTable(const FString Name)
{
...
void AMyPlayerController::ShowTrainWidget()
{
	if (TrainWidget != nullptr)
	{
...
void AMyPlayerController::HideTrainWidget()
{
	if (TrainWidget != nullptr)
	{
		PaintWidget->RemoveAllPoints();
